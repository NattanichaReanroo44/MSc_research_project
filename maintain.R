...
# M9: with magnitude and depth
formula_m9_maintain <- bf(
  recovery_y | cens(censor_type, recovery_y2) ~
    magnitude + depth + mean_pga + ntl_decline_ratio +
...
m9_maintain_result <- fit_bayes_aft(
  formula = formula_m9_maintain,
  model_name = "M9_maintain",
  family_name = "weibull",
  random_effect = TRUE,
