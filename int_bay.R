...
# ------------------------------------------------------------
# COMMON PRIORS
# Replace these with your exact common_priors if already defined
# ------------------------------------------------------------

common_priors <- c(
  prior(normal(0, 1), class = "b"),
  prior(normal(log(60), 1.5), class = "Intercept")
)
...
# ------------------------------------------------------------
# FORMULAS
# Example uses M1-M14 RHS specifications already defined
# ------------------------------------------------------------
